...
namespace DeliciousBrains\WPMDB\Container\Dotenv\Regex;

use DeliciousBrains\WPMDB\Container\Dotenv\Result\Error;
use DeliciousBrains\WPMDB\Container\Dotenv\Result\Result;
use DeliciousBrains\WPMDB\Container\Dotenv\Result\Success;
class Regex
{
    /**
